function [Q,maxk,maxvar,dreward,MA_noise_n]=updateQTablePermNoReset(Qtable_Integrated,reward, new_state,action , currentState, counts, Parameters)
Q=Qtable_Integrated;
