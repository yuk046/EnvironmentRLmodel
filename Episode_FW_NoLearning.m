function [ total_reward,i,Q,Model,last_actions,last_states,last_reward,last_Q,lastMaxK,lastMaxVar,lastDreward,lastMA_noise_n ] = Episode_FW_NoLearning( maxsteps, alpha, gamma,epsilon,MFParameters,grafic,Environment,start,p_steps )
